...
require('lazy').setup({
  ...
  { -- File explorer sidebar
    ...
    keys = {
      { '<leader>e', '<cmd>NERDTreeToggle<CR>', desc = 'Toggle file [E]xplorer' },
      { '<leader>E', '<cmd>NERDTreeFind<CR>', desc = 'Find current file in [E]xplorer' },
    },
    init = function()
      ...
      vim.g.NERDTreeIgnore = { '\\.pyc$', '__pycache__', '\\.git$', 'node_modules', '\\.DS_Store' }
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('BufEnter', {
        ...
        desc = 'Close Neovim if NERDTree is the last window',
        callback = function()
...
-- Additional tab/indentation settings
